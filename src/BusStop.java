...
public class BusStop implements Comparable<BusStop> 
{
    ...
    public BusStop(int ID, int code, String name, String desc, double lat, double lon, String zoneID, int locType, int parent) 
    {
        this.ID = ID;
        this.code = code;
        this.name = name;
    ...
    public String toString() 
    {
        ...
        return "[" + index + "] Stop ID: " + ID + ", Stop Code: " + (code == -1? "N/A":code) + ", " + name + ", "
                + desc;
    }
